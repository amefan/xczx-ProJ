package com.afan.manage_course.service;
...
import com.afan.manage_course.dao.CourseBaseRepository;
import com.afan.manage_course.dao.TeachplanMapper;
import com.afan.manage_course.dao.TeachplanRepository;
...
public class CourseService {
    ...
    public QueryResponseResult findBaseCourseList(int page, int size) {
        ...
        Page<CourseBase> pageList = courseBaseRepository.findAll(pageable);// 分页查询
